...
import { mockFirearms, mockAdditionalElements, mockCourses } from '../data/mockData';
  ...
  useEffect(() => {
    ...
    if (course) {
      setFormData({
        ...
        requirements: course.requirementsMet,
        firearms: course.firearms,
        legalKnowledge: course.legalKnowledge,
        mentalHealthTraining: course.mentalHealthTraining,
        additionalElements: course.additionalElements,
